...
const Header: FC<HeaderProps> = ({ site, menu }) => {
  return (
    <nav className='max-w-screen-2xl font-heading bg-bg/[.5] border-muted/[.2] fixed inset-x-0 top-0 z-[99] mx-auto flex items-center justify-between border-b py-2 px-4 backdrop-blur-xl sm:py-4'>
      <ul>
